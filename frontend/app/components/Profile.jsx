...
const Profile = ({ name, desc, profileImage, blogs, handleEdit, handleDelete, isVerified }) => {
  ...
  return (
    <section className='w-full max-w-full flex items-center justify-center flex-col mt-10'>
      ...
      />
      <h1 className="head_text text-white text-center">{name}'s Collection<br />{isVerified ? (<span className="verified-text text-green-500">Email verified</span>) : (<span className="verified-text text-red-500">Please verify your email !</span>)}</h1>
